...
function activate() {
    console.error("[TOOL] notification-sender activated");
    console.error(`[Notification Sender] Desktop notifications ${desktopNotificationsAvailable ? 'available' : 'not available'}`);
}
/**
...
function onSessionStart(session) {
    console.error(`[Notification Sender] Session started: ${session.id}`);
    ...
    try {
        ...
        switch (channel) {
            ...
            case 'webhook':
                ...
                console.error(`[Notification Sender] Would send webhook to ${webhookUrl} with payload:`, {
                    id,
                    level,
                    title,
                    message,
 ...
 */
async function handleConfigureThresholds(args) {
    try {
 ...
 */
async function handleTestChannels(args) {
    try {
