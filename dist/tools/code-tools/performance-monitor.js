...
function activate() {
    console.error("[TOOL] performance-monitor activated");
...
function onSessionStart(session) {
    console.error(`[Performance Monitor] Session started: ${session.id}`);
 ...
 */
async function handleRecordMetric(args) {
    try {
 ...
 */
async function handleStartTrace(args) {
    try {
 ...
 */
async function handleEndTrace(args) {
    try {
 ...
 */
async function handleRecordHistogram(args) {
    try {
 ...
 */
async function handleGetTraces(args) {
    try {
 ...
 */
async function handleGetHistograms(args) {
    try {
 ...
 */
async function handleSystemMetrics(args) {
    try {
