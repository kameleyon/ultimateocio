...
function onSessionStart(session) {
    console.error(`[Doc Generator] Session started: ${session.id}`);
...
async function isFileDocumented(filePath) {
    try {
 ...
 */
async function handleGenerateReadme(args) {
    try {
 ...
 */
async function handleAnalyzeDoc(args) {
    try {
