...
function activate() {
    console.error("[TOOL] schema-validator activated");
    // Clear caches
    schemasCache.clear();
...
function onSessionStart(session) {
    console.error(`[Schema Validator] Session started: ${session.id}`);
 ...
 */
async function parseSchema(schemaPath, schemaContent, schemaFormat) {
 ...
 */
async function parseData(dataPath, dataContent, dataFormat) {
    // Get data content
    let content;
    if (dataContent) {
        content = dataContent;
 ...
 */
async function handleValidateSchema(args) {
    try {
 ...
 */
async function handleCompileSchema(args) {
    try {
 ...
 */
async function handleAnalyzeSchema(args) {
    try {
 ...
 */
async function handleGenerateSchema(args) {
    try {
 ...
 */
async function handleConvertSchema(args) {
    try {
