...
`.trim().replace(/\s+/g, ' ');
function activate() {
    console.error("[TOOL] mock-data-inserter activated");
}
/**
...
function onSessionStart(session) {
    console.error(`[Mock Data Inserter] Session started: ${session.id}`);
}
// Function declarations
/**
 * Handles generating mock data
 */
async function handleGenerateMockData(args) {
    try {
 ...
 */
async function handleInsertMockData(args) {
    try {
 ...
 */
async function handleCustomizeMockData(args) {
    try {
