...
// Current state
let chatLoggerState = Object.assign({}, DEFAULT_CHAT_LOGGER_STATE);
function activate() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (fsSync.existsSync(CONFIG_FILE)) {
                const configData = yield fs.readFile(CONFIG_FILE, 'utf8');
...
function saveConfig() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield fs.writeFile(CONFIG_FILE, JSON.stringify(chatLoggerState, null, 2), 'utf8');
...
function loadConversation(conversationId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const filePath = path.join(CONVERSATION_DIR, `${conversationId}.json`);
            if (fsSync.existsSync(filePath)) {
                const conversationData = yield fs.readFile(filePath, 'utf8');
...
function saveConversation(conversation) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield fs.writeFile(filePath, JSON.stringify(conversation, null, 2), 'utf8');
        }
        catch (error) {
...
function anonymizeData(data, fields = ['userId', 'userName', 'ip', 'userAgent']) {
    ...
    const result = Array.isArray(data) ? [...data] : Object.assign({}, data);
    // Handle arrays
 ...
 */
function handleLogMessage(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!chatLoggerState.conversations[conversationId]) {
                const loadedConversation = yield loadConversation(conversationId);
 ...
 */
function handleGetConversation(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
...
function handleListConversations(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (userId) {
                filteredConversations = filteredConversations.filter(c => { var _a; return ((_a = c.metadata) === null || _a === void 0 ? void 0 : _a.userId) === userId; });
            }
            if (tags && tags.length > 0) {
                filteredConversations = filteredConversations.filter(c => { var _a; return ((_a = c.metadata) === null || _a === void 0 ? void 0 : _a.tags) && tags.every(tag => { var _a, _b; return (_b = (_a = c.metadata) === null || _a === void 0 ? void 0 : _a.tags) === null || _b === void 0 ? void 0 : _b.includes(tag); }); });
            }
            if (category) {
                filteredConversations = filteredConversations.filter(c => { var _a; return ((_a = c.metadata) === null || _a === void 0 ? void 0 : _a.category) === category; });
            }
            // Sort conversations
...
function handleSearchMessages(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
                ...
                for (const file of files) {
                    if (path.extname(file) === '.json') {
                        ...
                        if (!chatLoggerState.conversations[id]) {
                            const conversation = yield loadConversation(id);
                            if (conversation) {
            ...
            if (userId) {
                relevantConversations = relevantConversations.filter(c => { var _a; return ((_a = c.metadata) === null || _a === void 0 ? void 0 : _a.userId) === userId; });
            }
            // Get all messages from relevant conversations
            let allMessages = [];
            relevantConversations.forEach(conversation => {
                const messagesWithTitle = conversation.messages.map(message => (Object.assign(Object.assign({}, message), { conversationTitle: conversation.title })));
            ...
            const formattedMessages = paginatedMessages.map(message => {
                if (!includeMetadata) {
                    // Exclude metadata
                    const { metadata } = message, messageWithoutMetadata = __rest(message, ["metadata"]);
 ...
 */
function handleExportConversation(args) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        try {
...
<body>
  ...
  <div class="metadata">
    ...
    ${((_a = dataToExport.metadata) === null || _a === void 0 ? void 0 : _a.tags) ? `<p>Tags: ${dataToExport.metadata.tags.join(', ')}</p>` : ''}
  </div>
  <div class="messages">
