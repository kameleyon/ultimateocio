    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (args && typeof args === 'object' && ('path' in args || 'content' in args)) {
            try {
                ...
                if (filePath) {
                    yield fs.writeFile(filePath, result.fixedCode);
                }
                return {
                    content: [{
                            type: "text",
 ...
 */
function handleAnalyzeCode(args) {
    return __awaiter(this, void 0, void 0, function* () {
        if (args && typeof args === 'object' && ('path' in args || 'content' in args)) {
            try {
                // Get the file content
 ...
 */
function handleFixProject(args) {
    return __awaiter(this, void 0, void 0, function* () {
        if (args && typeof args === 'object' && 'directory' in args && typeof args.directory === 'string') {
            try {
                ...
                const files = yield getFilesInDirectory(directory, recursive, extensions);
                ...
                for (let i = 0; i < files.length; i += batchSize) {
                    ...
                    const batchResults = yield Promise.all(batch.map((filePath) => __awaiter(this, void 0, void 0, function* () {
                        try {
                            ...
                            const result = yield Promise.race([processingPromise, timeoutPromise]);
                            return result;
                        }
                        catch (error) {
                            return {
 ...
 */
function processFile(filePath, fixTypes) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // Determine the language
 ...
 */
function getFilesInDirectory(directory, recursive, extensions) {
    return __awaiter(this, void 0, void 0, function* () {
        const files = [];
        ...
        try {
            ...
            for (const entry of entries) {
                ...
                if (entry.isDirectory() && recursive) {
                    const subFiles = yield getFilesInDirectory(entryPath, recursive, extensions);
 ...
 */
function processLargeFile(filePath, language, fixTypes) {
    return __awaiter(this, void 0, void 0, function* () {
