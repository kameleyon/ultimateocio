...
function detectTestFramework() {
    ...
    try {
        ...
        if (fsSync.existsSync('package.json')) {
            ...
            // Check for Jest
            if (dependencies.jest || ((_b = (_a = packageJson.scripts) === null || _a === void 0 ? void 0 : _a.test) === null || _b === void 0 ? void 0 : _b.includes('jest'))) {
                console.log('[Test Runner] Detected Jest framework');
                detectedFramework = 'jest';
                return 'jest';
            }
            // Check for Vitest
            if (dependencies.vitest || ((_d = (_c = packageJson.scripts) === null || _c === void 0 ? void 0 : _c.test) === null || _d === void 0 ? void 0 : _d.includes('vitest'))) {
                console.log('[Test Runner] Detected Vitest framework');
                detectedFramework = 'vitest';
                return 'vitest';
            }
            // Check for Mocha
            if (dependencies.mocha || ((_f = (_e = packageJson.scripts) === null || _e === void 0 ? void 0 : _e.test) === null || _f === void 0 ? void 0 : _f.includes('mocha'))) {
                console.log('[Test Runner] Detected Mocha framework');
                detectedFramework = 'mocha';
                return 'mocha';
            }
            // Check for Jasmine
            if (dependencies.jasmine || ((_h = (_g = packageJson.scripts) === null || _g === void 0 ? void 0 : _g.test) === null || _h === void 0 ? void 0 : _h.includes('jasmine'))) {
                console.log('[Test Runner] Detected Jasmine framework');
                detectedFramework = 'jasmine';
                return 'jasmine';
            }
            // Check for Karma
            if (dependencies.karma || ((_k = (_j = packageJson.scripts) === null || _j === void 0 ? void 0 : _j.test) === null || _k === void 0 ? void 0 : _k.includes('karma'))) {
                console.log('[Test Runner] Detected Karma framework');
                detectedFramework = 'karma';
                return 'karma';
            }
            // Check for Cypress
            if (dependencies.cypress || ((_m = (_l = packageJson.scripts) === null || _l === void 0 ? void 0 : _l.test) === null || _m === void 0 ? void 0 : _m.includes('cypress'))) {
                console.log('[Test Runner] Detected Cypress framework');
                detectedFramework = 'cypress';
                return 'cypress';
            }
            // Check for Playwright
            if (dependencies.playwright || ((_p = (_o = packageJson.scripts) === null || _o === void 0 ? void 0 : _o.test) === null || _p === void 0 ? void 0 : _p.includes('playwright'))) {
        ...
        if (fsSync.existsSync('package.json')) {
            const packageJson = JSON.parse(fsSync.readFileSync('package.json', 'utf8'));
            if ((_q = packageJson.scripts) === null || _q === void 0 ? void 0 : _q.test) {
...
function getTestScript() {
    ...
    try {
        if (fsSync.existsSync('package.json')) {
            const packageJson = JSON.parse(fsSync.readFileSync('package.json', 'utf8'));
            if ((_a = packageJson.scripts) === null || _a === void 0 ? void 0 : _a.test) {
                ...
                return {
                    content: [{
                            ...
                            text: JSON.stringify({
                                ...
                                framework,
                                summary: (_a = testRun.results) === null || _a === void 0 ? void 0 : _a.summary,
 ...
 */
function handleWatchTests(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
 ...
 */
function handleGetTestHistory(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const formattedRuns = filteredRuns.map(run => {
                ...
                return ({
                    ...
                    command: run.command,
                    summary: ((_a = run.results) === null || _a === void 0 ? void 0 : _a.summary) || null,
 ...
 */
function handleGetCoverage(args) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a, _b;
        try {
            ...
            if (testRunId) {
                ...
                if ((_b = (_a = testRun.results) === null || _a === void 0 ? void 0 : _a.summary) === null || _b === void 0 ? void 0 : _b.coverage) {
                    return {
                        content: [{
                                type: "text",
                                text: JSON.stringify({
 ...
 */
function handleGetTestInfo(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (detectOnly) {
                ...
                switch (framework) {
                    ...
                    default:
                        ...
                        try {
                            const testFiles = yield findTestFiles(testPattern || '.');
                            const onlyTests = [];
            ...
            return {
                content: [{
                        type: "text",
                        text: JSON.stringify(Object.assign(Object.assign({}, testInfo), { message: `Found ${testInfo.testFileCount || 0} test files for ${framework} framework` }), null, 2)
                    }]
            };
        }
        catch (error) {
