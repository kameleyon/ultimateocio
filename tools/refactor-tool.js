 ...
 */
function handleRenameSymbol(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (isGlobal) {
                ...
                filesToProcess = yield findTsJsFiles(directory);
            }
            // Process each file
            const results = [];
...
function handleExtractMethod(args) {
    return __awaiter(this, void 0, void 0, function* () {
...
function handleExtractInterface(args) {
    return __awaiter(this, void 0, void 0, function* () {
...
function handleMoveSymbol(args) {
    return __awaiter(this, void 0, void 0, function* () {
...
function handleInlineCode(args) {
    return __awaiter(this, void 0, void 0, function* () {
