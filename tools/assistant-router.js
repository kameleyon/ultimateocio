...
let routerState = Object.assign({}, DEFAULT_ROUTER_STATE);
function activate() {
...
function saveConfig() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield fs.writeFile(CONFIG_FILE_PATH, JSON.stringify(routerState, null, 2), 'utf8');
...
function routeRequest(input) {
    ...
    const historyEntry = {
        ...
        timestamp: Date.now(),
        input,
        matchedRuleId: matchedRule === null || matchedRule === void 0 ? void 0 : matchedRule.id,
        targetAssistantId,
        success,
    ...
    return __awaiter(this, void 0, void 0, function* () {
        switch (command.name) {
            ...
            case 'assistant-router:update-config':
                ...
                return yield handleUpdateConfig(command.args[0]);
            default:
 ...
 */
function handleRouteRequest(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (analyzeOnly || routerState.config.analysisMode) {
                ...
                const ruleAnalysis = enabledRules.map(rule => {
                    ...
                    return {
                        ...
                        targetAssistantName: ((_a = routerState.assistants[rule.targetAssistantId]) === null || _a === void 0 ? void 0 : _a.name) || 'Unknown'
                    };
                });
                ...
                if (selectedRule) {
                    ...
                    if (!targetAssistant || !targetAssistant.enabled) {
                        ...
                        if (rule.fallbackAssistantId &&
                            ...
                            // Fall back to default
                            targetAssistantId = routerState.config.defaultAssistantId;
                            targetAssistantName = ((_a = routerState.assistants[targetAssistantId]) === null || _a === void 0 ? void 0 : _a.name) || 'Unknown default';
                        }
                    }
                    else {
                    ...
                    // No rule matched, use default assistant
                    targetAssistantId = routerState.config.defaultAssistantId;
                    targetAssistantName = ((_b = routerState.assistants[targetAssistantId]) === null || _b === void 0 ? void 0 : _b.name) || 'Unknown default';
                }
                return {
                    content: [{
                            type: "text",
                            text: JSON.stringify({
                                analysis: {
                                    ...
                                    selectedRuleId: selectedRule === null || selectedRule === void 0 ? void 0 : selectedRule.ruleId,
                                    selectedRuleName: selectedRule === null || selectedRule === void 0 ? void 0 : selectedRule.ruleName,
                                    targetAssistantId,
                                    targetAssistantName,
                                ...
                                message: matchingRules.length > 0
                                    ? `Input would route to '${targetAssistantName}' assistant via rule '${selectedRule === null || selectedRule === void 0 ? void 0 : selectedRule.ruleName}'`
                ...
                return {
                    content: [{
                            ...
                            text: JSON.stringify({
                                ...
                                matchedRuleId: (_c = routeResult.matchedRule) === null || _c === void 0 ? void 0 : _c.id,
            ...
            return {
                content: [{
                        ...
                        text: JSON.stringify({
                            assistantId: routeResult.assistantId,
                            assistantName: (_d = routeResult.assistant) === null || _d === void 0 ? void 0 : _d.name,
                            assistantType: (_e = routeResult.assistant) === null || _e === void 0 ? void 0 : _e.type,
                            matchedRuleId: (_f = routeResult.matchedRule) === null || _f === void 0 ? void 0 : _f.id,
                            matchedRuleName: (_g = routeResult.matchedRule) === null || _g === void 0 ? void 0 : _g.name,
                            message: routeResult.matchedRule
                                ? `Routed to '${(_h = routeResult.assistant) === null || _h === void 0 ? void 0 : _h.name}' assistant via rule '${routeResult.matchedRule.name}'`
                                : `Routed to default assistant '${(_j = routeResult.assistant) === null || _j === void 0 ? void 0 : _j.name}'`
                        }, null, 2)
                    }]
            };
        }
 ...
 */
function handleAddAssistant(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
 ...
 */
function handleListAssistants(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const formattedRules = filteredRules.map(rule => {
                ...
                const formatted = {
                    ...
                    fallbackAssistantName: rule.fallbackAssistantId
                        ? ((_b = routerState.assistants[rule.fallbackAssistantId]) === null || _b === void 0 ? void 0 : _b.name) || 'Unknown'
                        : undefined,
        ...
        try {
            ...
            const formattedEntries = paginatedEntries.map(entry => {
                ...
                const formatted = {
                    ...
                    matchedRuleName: entry.matchedRuleId ? (_a = routerState.rules[entry.matchedRuleId]) === null || _a === void 0 ? void 0 : _a.name : null,
                    targetAssistantId: entry.targetAssistantId,
                    targetAssistantName: ((_b = routerState.assistants[entry.targetAssistantId]) === null || _b === void 0 ? void 0 : _b.name) || 'Unknown',
 ...
 */
function handleUpdateConfig(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
