    ...
    return __awaiter(this, void 0, void 0, function* () {
        switch (command.name) {
            case 'error-logger:log':
                return yield handleLog(command.args[0]);
            case 'error-logger:configure':
                return yield handleConfigure(command.args[0]);
            case 'error-logger:query':
                return yield handleQuery(command.args[0]);
            case 'error-logger:rotate':
                return yield handleRotate(command.args[0]);
            default:
...
function ensureLogDir() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield fs.mkdir(settings.logDir, { recursive: true });
        }
        catch (error) {
...
function log(entry) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const formattedEntry = Object.assign(Object.assign({}, entry), { timestamp, datetime: new Date(timestamp).toISOString(), hostname: os.hostname(), pid: process.pid });
        ...
        try {
            ...
            yield rotateIfNeeded();
            // Append to log file
            yield fs.appendFile(settings.logFile, message);
        }
        catch (error) {
...
function rotateIfNeeded() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            try {
                yield fs.access(settings.logFile);
            }
            catch (_a) {
...
function handleQuery(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Read log file
            const content = yield fs.readFile(settings.logFile, 'utf8');
