    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (fsSync.existsSync('tools-info.json')) {
                const toolsData = yield fs.readFile('tools-info.json', 'utf8');
                ...
                if (Array.isArray(loadedTools) && loadedTools.length > 0) {
                    ...
                    for (const loadedTool of loadedTools) {
                        ...
                        if (existingIndex >= 0) {
                            mergedTools[existingIndex] = Object.assign(Object.assign({}, mergedTools[existingIndex]), loadedTool);
                        }
                        else {
 ...
 */
function saveToolsInfo() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield fs.writeFile('tools-info.json', JSON.stringify(tools, null, 2), 'utf8');
...
function registerTool(tool) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (existingIndex >= 0) {
            ...
            tools[existingIndex] = Object.assign(Object.assign({}, tools[existingIndex]), tool);
        }
        else {
            // Add new tool
            tools.push(tool);
 ...
 */
function handleSuggestTools(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
 ...
 */
function handleGetToolInfo(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
 ...
 */
function handleRegisterTool(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Register the tool
            const success = yield registerTool(result.data);
            if (!success) {
                return {
                    content: [{
                            type: "text",
 ...
 */
function handleGetCategories(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
