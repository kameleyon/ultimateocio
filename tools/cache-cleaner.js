...
exports.CacheStatusSchema = exports.OptimizeMemorySchema = exports.AnalyzeCacheSchema = exports.CleanCacheSchema = void 0;
...
exports.CleanCacheSchema = zod_1.z.object({
    directories: zod_1.z.array(zod_1.z.string()).optional(),
    recursive: zod_1.z.boolean().optional().default(true),
    ageThreshold: zod_1.z.number().optional().default(7 * 24 * 60 * 60 * 1000), // 7 days in ms
    sizeThreshold: zod_1.z.number().optional().default(100 * 1024 * 1024), // 100 MB in bytes
    dryRun: zod_1.z.boolean().optional().default(false),
    skipPatterns: zod_1.z.array(zod_1.z.string()).optional(),
});
exports.AnalyzeCacheSchema = zod_1.z.object({
    directories: zod_1.z.array(zod_1.z.string()).optional(),
    recursive: zod_1.z.boolean().optional().default(true),
    includeDetails: zod_1.z.boolean().optional().default(false),
    groupBy: zod_1.z.enum(['directory', 'age', 'type', 'size']).optional().default('directory'),
});
exports.OptimizeMemorySchema = zod_1.z.object({
    target: zod_1.z.enum(['heap', 'processes', 'disk', 'all']).optional().default('all'),
    aggressive: zod_1.z.boolean().optional().default(false),
    logLevel: zod_1.z.enum(['silent', 'normal', 'verbose']).optional().default('normal'),
});
exports.CacheStatusSchema = zod_1.z.object({
    directories: zod_1.z.array(zod_1.z.string()).optional(),
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            for (const dir of defaultCacheDirs) {
                try {
                    const stats = yield getCacheDirStats(dir);
 ...
 */
function getDefaultCacheDirectories() {
    const directories = [];
    // Add temp directory
 ...
 */
function getCacheDirStats(directory) {
    return __awaiter(this, void 0, void 0, function* () {
        let totalSize = 0;
        let fileCount = 0;
        try {
 ...
 */
function handleCleanCache(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = exports.CleanCacheSchema.safeParse(args);
            if (!result.success) {
                return {
                    content: [{
                            type: "text",
            ...
            return {
                content: [{
                        ...
                        text: JSON.stringify({
                            ...
                            directoryResults: cleanupResults.directoryResults.map(result => (Object.assign(Object.assign({}, result), { freedSpace: formatBytes(result.freedSpace) }))),
                            dryRun,
                            message: dryRun
 ...
 */
function handleAnalyzeCache(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = exports.AnalyzeCacheSchema.safeParse(args);
            if (!result.success) {
                return {
                    content: [{
                            type: "text",
            ...
            return {
                content: [{
                        ...
                        text: JSON.stringify({
                            ...
                            largestFile: Object.assign(Object.assign({}, analysisResults.largestFile), { size: formatBytes(analysisResults.largestFile.size) }),
                            directoryBreakdown: analysisResults.directoryBreakdown.map(dir => (Object.assign(Object.assign({}, dir), { size: formatBytes(dir.size) }))),
                            fileTypeBreakdown: analysisResults.fileTypeBreakdown.map(type => (Object.assign(Object.assign({}, type), { size: formatBytes(type.size) }))),
 ...
 */
function handleOptimizeMemory(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = exports.OptimizeMemorySchema.safeParse(args);
            if (!result.success) {
                return {
                    content: [{
                            type: "text",
            ...
            return {
                content: [{
                        ...
                        text: JSON.stringify({
                            ...
                            optimizations: optimizationResults.optimizations.map(opt => (Object.assign(Object.assign({}, opt), { freedBytes: formatBytes(opt.freedBytes) }))),
                            target,
                            aggressive,
                            message: `Memory optimization complete. Total memory freed: ${formatBytes((optimizationResults.memoryBefore.heapUsed - optimizationResults.memoryAfter.heapUsed) +
 ...
 */
function handleCacheStatus(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const result = exports.CacheStatusSchema.safeParse(args);
            if (!result.success) {
                return {
                    content: [{
                            type: "text",
            ...
            return {
                content: [{
                        type: "text",
                        text: JSON.stringify({
                            cacheDirectories: statusResults.cacheDirectories.map(dir => (Object.assign(Object.assign({}, dir), { size: formatBytes(dir.size) }))),
                            systemStatus: statusResults.systemStatus ? Object.assign(Object.assign({}, statusResults.systemStatus), { freeMem: formatBytes(statusResults.systemStatus.freeMem), totalMem: formatBytes(statusResults.systemStatus.totalMem), uptime: `${Math.floor(statusResults.systemStatus.uptime / 3600)} hours, ${Math.floor((statusResults.systemStatus.uptime % 3600) / 60)} minutes` }) : undefined,
