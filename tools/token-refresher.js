    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (fsSync.existsSync(CONFIG_FILE_PATH)) {
                const storeData = yield fs.readFile(CONFIG_FILE_PATH, 'utf8');
...
function saveTokenStore() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield fs.writeFile(CONFIG_FILE_PATH, JSON.stringify(tokenStore, null, 2), 'utf8');
...
function isTokenExpired(token) {
    var _a, _b;
    if (token.type === 'jwt' && ((_b = (_a = token.decoded) === null || _a === void 0 ? void 0 : _a.payload) === null || _b === void 0 ? void 0 : _b.exp)) {
 ...
 */
function handleDecodeToken(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (storeResult) {
                ...
                const metadata = Object.assign({ name: name || `Token ${tokenId.substring(0, 6)}`, description: description || 'Decoded from JWT', createdAt: Date.now() }, extractJWTMetadata(decoded));
                // Create stored token
                const storedToken = {
                    id: tokenId,
                    type: 'jwt',
 ...
 */
function handleRefreshToken(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
 ...
 */
function handleStoreToken(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const baseMetadata = Object.assign({ name,
                description, createdAt: Date.now(), updatedAt: Date.now(), expiresAt }, metadata);
            ...
            const storedToken = {
                ...
                value: token,
                decoded,
                metadata: Object.assign(Object.assign({}, baseMetadata), extractedMetadata),
                refreshToken,
                refreshUrl,
                refreshHeaders,
                refreshData,
 ...
 */
function handleValidateToken(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            return {
                content: [{
                        type: "text",
                        text: JSON.stringify(Object.assign(Object.assign({}, verificationResult), { storedTokenId: storedToken === null || storedToken === void 0 ? void 0 : storedToken.id, message: validationStatus === 'valid'
                                ? 'Token is valid'
                                : validationStatus === 'expired'
                                    ? 'Token has expired'
                                    : 'Token is invalid' }), null, 2)
                    }]
            };
        }
        catch (error) {
 ...
 */
function handleListTokens(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (filter) {
                ...
                tokens = tokens.filter(token => {
                    var _a;
                    return token.metadata.name.toLowerCase().includes(filterLower) ||
                        ((_a = token.metadata.description) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(filterLower)) ||
 ...
 */
function handleDeleteToken(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
