    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            for (const path of possiblePaths) {
                try {
                    prettier = yield Promise.resolve(`${path}`).then(s => __importStar(require(s)));
        ...
        try {
            ...
            for (const path of possiblePaths) {
                try {
                    jsBeautify = yield Promise.resolve(`${path}`).then(s => __importStar(require(s)));
    ...
    return __awaiter(this, void 0, void 0, function* () {
        switch (command.name) {
            case 'formatter:format':
                ...
                return yield handleFormatContent(command.args[0]);
            case 'formatter:format-file':
                console.log('[Formatter] Formatting file...');
                return yield handleFormatFile(command.args[0]);
            case 'formatter:detect':
                console.log('[Formatter] Detecting format...');
                return yield handleDetectFormat(command.args[0]);
            case 'formatter:convert':
                console.log('[Formatter] Converting format...');
                return yield handleConvertFormat(command.args[0]);
            default:
 ...
 */
function formatCode(content, language, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (prettier) {
                const prettierOptions = Object.assign({ parser: getPrettierParser(language) }, options);
                try {
 ...
 */
function handleFormatContent(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Format the content
            const formattedContent = yield formatCode(content, language, options);
            return {
                content: [{
                        type: "text",
                        text: JSON.stringify({
...
function handleFormatFile(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Format the content
            const formattedContent = yield formatCode(fileContent, detectedLanguage, options);
 ...
 */
function handleDetectFormat(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (filePath) {
                try {
                    fileContent = yield fs.readFile(filePath, 'utf8');
 ...
 */
function handleConvertFormat(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
