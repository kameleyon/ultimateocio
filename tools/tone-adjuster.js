...
// Current active tone
let activeTone = ((_a = DEFAULT_TONE_PROFILES.find(p => p.isDefault)) === null || _a === void 0 ? void 0 : _a.name) || 'Simple';
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (fsSync.existsSync('tone-profiles.json')) {
                const profilesData = yield fs.readFile('tone-profiles.json', 'utf8');
                ...
                if (fsSync.existsSync('active-tone.json')) {
                    const activeToneData = yield fs.readFile('active-tone.json', 'utf8');
...
function saveProfiles() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield fs.writeFile('tone-profiles.json', JSON.stringify(toneProfiles, null, 2), 'utf8');
            console.log(`[Tone Adjuster] Saved ${toneProfiles.length} tone profiles`);
            // Save active tone
            yield fs.writeFile('active-tone.json', JSON.stringify({ active: activeTone }, null, 2), 'utf8');
 ...
 */
function handleAdjustText(args) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            if (settings) {
                ...
                toneSettings = {
                    formality: (_a = settings.formality) !== null && _a !== void 0 ? _a : 50,
                    complexity: (_b = settings.complexity) !== null && _b !== void 0 ? _b : 50,
                    emotion: (_c = settings.emotion) !== null && _c !== void 0 ? _c : 50,
                    confidence: (_d = settings.confidence) !== null && _d !== void 0 ? _d : 50,
                    personalization: (_e = settings.personalization) !== null && _e !== void 0 ? _e : 50,
                    enthusiasm: (_f = settings.enthusiasm) !== null && _f !== void 0 ? _f : 50,
                    technicality: (_g = settings.technicality) !== null && _g !== void 0 ? _g : 50,
                    wordiness: (_h = settings.wordiness) !== null && _h !== void 0 ? _h : 50
                };
            }
            else if (toneName) {
 ...
 */
function handleCreateProfile(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (isDefault) {
                toneProfiles = toneProfiles.map(profile => (Object.assign(Object.assign({}, profile), { isDefault: false })));
 ...
 */
function handleSetActiveTone(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
 ...
 */
function handleGetActiveTone(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
 ...
 */
function handleDeleteProfile(args) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        try {
            ...
            if (activeTone === profileName) {
                ...
                if (newActiveTone) {
                    ...
                    activeTone = ((_a = toneProfiles.find(p => p.name !== profileName)) === null || _a === void 0 ? void 0 : _a.name) || 'Simple';
                }
                else {
                    return {
                        content: [{
 ...
 */
function handleAddReplacementRule(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
