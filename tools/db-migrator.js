...
function loadSettingsAndState() {
    try {
        ...
        if (fsSync.existsSync('db-migrator.json')) {
            ...
            currentSettings = Object.assign(Object.assign({}, DEFAULT_SETTINGS), settings);
...
function saveState() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            yield fs.writeFile(stateFilePath, JSON.stringify(migrationState, null, 2), 'utf8');
        }
        catch (error) {
...
function createMigrationFile(options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (currentSettings.createSubdirectories) {
            ...
            if (!fsSync.existsSync(migrationsDir)) {
                yield fs.mkdir(migrationsDir, { recursive: true });
            }
        }
        // Format the filename
            ...
            for (const file of files) {
                ...
                try {
                    ...
                    const migration = {
                        ...
                        appliedAt: (_a = migrationState.appliedMigrations[filePath]) === null || _a === void 0 ? void 0 : _a.timestamp
                    };
...
function handleCreateMigration(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const migration = yield createMigrationFile({
                name,
                type,
                database,
                description,
 ...
 */
function handleRunMigrations(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // Get all migration files
            const allMigrations = yield getMigrationFiles();
 ...
 */
function handleMigrationStatus(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
 ...
 */
function handleRollbackMigration(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
 ...
 */
function handleConfigureMigrator(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            currentSettings = Object.assign(Object.assign({}, currentSettings), result.data);
            // Save settings to file
            yield fs.writeFile('db-migrator.json', JSON.stringify(currentSettings, null, 2), 'utf8');
            // Create migrations directory if it doesn't exist
