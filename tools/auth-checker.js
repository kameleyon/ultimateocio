    ...
    return __awaiter(this, void 0, void 0, function* () {
        switch (command.name) {
            ...
            case 'auth-checker:analyze':
                ...
                return yield handleAnalyzeAuthFlow(command.args[0]);
            case 'auth-checker:secure':
                console.log('[Auth Checker] Securing endpoints...');
                return yield handleSecureEndpoints(command.args[0]);
            default:
 ...
 */
function handleAnalyzeAuthFlow(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
 ...
 */
function handleSecureEndpoints(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
