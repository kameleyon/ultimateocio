 ...
 */
function cacheEnvironmentVariables() {
    return __awaiter(this, void 0, void 0, function* () {
        // Reset cache
        environmentCache = {};
...
function maskSensitiveValues(vars) {
    ...
    const masked = Object.assign({}, vars);
            ...
            if (envFile) {
                try {
                    ...
                    if (fsSync.existsSync(envFilePath)) {
                        // Parse the env file
                        const content = yield fs.readFile(envFilePath, 'utf-8');
                        const envVars = dotenv.parse(content);
                        value = envVars[key];
                    }
                }
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (!fileExists) {
                ...
                // Create empty file
                yield fs.writeFile(envFilePath, '');
            }
            // Backup the file if requested
            if (backup && fileExists) {
                yield fs.copyFile(envFilePath, `${envFilePath}.bak`);
            }
            // Read the current content
            let content = '';
            if (fileExists) {
                content = yield fs.readFile(envFilePath, 'utf-8');
            }
            // Format the value
            ...
            yield fs.writeFile(envFilePath, content);
            // Update the cache
            yield cacheEnvironmentVariables();
            return {
                content: [{
                        type: "text",
                        text: JSON.stringify({
 ...
 */
function handleListEnvVars(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (envFile) {
                ...
                for (const fileVars of Object.values(environmentCache)) {
                    vars = Object.assign(Object.assign({}, vars), fileVars);
                }
                ...
                if (includeSystem) {
                    ...
                    vars = Object.assign(Object.assign({}, vars), systemEnv);
                }
            }
 ...
 */
function handleValidateEnvVars(args) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (schema) {
                ...
                const content = yield fs.readFile(templatePath, 'utf-8');
